...
*/
var materias = ["matematica", "lengua", "biologia", "quimica", "fisica"];
for (var index = 0; index < materias.length; index++) {
    alert(materias[index]);   
}
/*
...
*/
for (var index = 0; index < materias.length; index++, materias.toString(0,1)) {
    alert(materias[index].substring(0,1).toUpperCase() + materias[index].substring(1,materias[index].length));    
}
/*
...
var sentence = "";
for (var index = 0; index < materias.length; index++) {
    sentence = sentence + materias[index] + " ";
}
alert(sentence);
/*
